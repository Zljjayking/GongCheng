...
@interface DDBuilderMoreTrain2Cell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *haveBLab1;
@property (weak, nonatomic) IBOutlet UILabel *haveBLab2;
