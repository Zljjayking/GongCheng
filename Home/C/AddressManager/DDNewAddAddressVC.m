...
#import "DDNewAddAddressVC.h"
#import <ContactsUI/ContactsUI.h>
#import "DDCitySelectPickerView.h"
#import "PlaceholdTextView.h"
@interface DDNewAddAddressVC ()<CNContactPickerDelegate,DDCitySelectPickerViewDelegate,UITextFieldDelegate,PlaceholdTextViewDelegate>
...
@implementation DDNewAddAddressVC
...
-(void)saveClick{
    ...
    [[DDHttpManager sharedInstance]sendPostRequest:KHttpRequest_newAddAddress params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********新增地址接口***************%@",responseObject);
