//
//  DDExaminationDynamicDetailVC.m
//  GongChengDD
//
...
@interface DDExaminationDynamicDetailVC ()<WKNavigationDelegate,WKUIDelegate>
...
@implementation DDExaminationDynamicDetailVC
...
- (void)viewDidLoad {
    ...
    NSString *urlStr=[NSString stringWithFormat:@"%@%@?noticeId=%@",DD_Http_Server,KHttpRequest_examDynamicDetail,self.noticeId];
