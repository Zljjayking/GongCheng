...
#import "DDExcutedPeopleDetailVC.h"
...
#import "DDLoseCreditDetailVC.h"//失信信息详情界面

@interface DDExcutedPeopleDetailVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDExcutedPeopleDetailVC
    ...
    if (_model.group) {
        if (indexPath.section==0) {
            ...
            if (indexPath.row==0) {
                ...
                cell.titleLab.text=@"身份证号/组织机构代码";
                ...
                cell.titleLab.text=@"执行标的";
                cell.detailLab.text=_model.executeStandard;
            }
            ...
            cell.numLab1.text=@"被执行人:";
            cell.numLab2.text=_model.group.executePerson;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (_model.group) {
        if (indexPath.section==1) {
            DDLoseCreditDetailVC *detail=[[DDLoseCreditDetailVC alloc]init];
