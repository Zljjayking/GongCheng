...
#import "DDProjectManagerVC.h"
#import "DDLabelUtil.h"
#import "MJRefresh.h"
#import "DDNavigationUtil.h"
#import "DataLoadingView.h"//加载页面
#import "DDNoResult2View.h"//无数据视图
#import "DDProjectManagerModel.h"//model
#import "DDProjectManagerCell.h"//cell
#import "DDPeopleDetailVC.h"//项目经理详情页面

@interface DDProjectManagerVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDProjectManagerVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyManagerList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********项目经理结果数据***************%@",responseObject);
        ...
        if (response.isSuccess) {
            ...
            if (listArr.count!=0) {
                ...
                for (NSDictionary *dic in listArr) {
                    DDProjectManagerModel *model = [[DDProjectManagerModel alloc]initWithDictionary:dic error:nil];
                ...
                [_noResultView showWithTitle:@"暂无相关项目经理的信息" subTitle:@"去其他地方看看~" image:@"noResult_person"];
            }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    DDProjectManagerModel *model=_dataSourceArr[indexPath.section];
    
    static NSString * cellID = @"DDProjectManagerCell";
    DDProjectManagerCell * cell = (DDProjectManagerCell *)[tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
