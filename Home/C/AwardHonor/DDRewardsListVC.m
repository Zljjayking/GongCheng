...
@interface DDRewardsListVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDRewardsListVC
...
-(void)editNavItem{
    if ([self.rewardType isEqualToString:@"1"]) {
        self.title=@"技术创新奖";
    }
    else{
        self.title=@"QC奖";
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyRewardGloryList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        ...
        if (response.isSuccess) {
            ...
            if (listArr.count!=0) {
                ...
                if ([self.rewardType isEqualToString:@"1"]) {
                    [_noResultView showWithTitle:@"暂无相关技术创新奖的信息" subTitle:@"去其他地方看看~" image:@"noResult_info"];
                }
                else{
                    [_noResultView showWithTitle:@"暂无相关QC奖的信息" subTitle:@"去其他地方看看~" image:@"noResult_info"];
                }
            }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.rewardType isEqualToString:@"1"]) {
        rewardGloryDetail.reward_group=@"1";
    }
    else{
        rewardGloryDetail.reward_group=@"2";
    }
