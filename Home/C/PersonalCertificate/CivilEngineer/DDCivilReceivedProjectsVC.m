...
@interface DDCivilReceivedProjectsVC ()<UITableViewDelegate,UITableViewDataSource,DDCivilProjectsHeaderViewDelegate>
...
@implementation DDCivilReceivedProjectsVC
...
-(void)createLoadView{
    ...
    _noResultView=[[DDNoResult2View alloc]initWithFrame:CGRectMake(0,0, Screen_Width, Screen_Height-KNavigationBarHeight-135-15-45)];
...
-(void)createTableView{
    _tableView=[[UITableView alloc]initWithFrame:CGRectMake(0, 0, Screen_Width, Screen_Height-KNavigationBarHeight-15-135-45) style:UITableViewStyleGrouped];
