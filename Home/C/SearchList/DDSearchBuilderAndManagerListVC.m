        ...
        if (response.isSuccess) {
            if (![response isEmpty]) {
                ...
                if (listArr.count!=0) {
                    ...
                    else if ([self.menuId isEqualToString:@"138"]) {//建筑师
                        [_noResultView showNoResultViewWithTitle:@"建筑师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"139"]) {//结构师
                        [_noResultView showNoResultViewWithTitle:@"结构师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"140"]) {//土木工程师
                        [_noResultView showNoResultViewWithTitle:@"土木工程师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"141"]) {//公用设备师
                        [_noResultView showNoResultViewWithTitle:@"公用设备师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"142"]) {//电气工程师
                        [_noResultView showNoResultViewWithTitle:@"电气工程师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"143"]) {//化工工程师
                        [_noResultView showNoResultViewWithTitle:@"化工工程师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"144"]) {//监理工程师
                        [_noResultView showNoResultViewWithTitle:@"监理工程师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"145"]) {//造价工程师
                        [_noResultView showNoResultViewWithTitle:@"造价工程师" andImage:@"noResult_person"];
                    }
                    else if ([self.menuId isEqualToString:@"146"]) {//消防工程师
                        [_noResultView showNoResultViewWithTitle:@"消防工程师" andImage:@"noResult_person"];
                    }
                }
            }
            else{
...
-(void)createChooseBtns{
    ...
    if ([self.menuId isEqualToString:@"18"]) {//建造师
        ...
        _rightLab.text=@"个土木工程师";
    }
    else if ([self.menuId isEqualToString:@"141"]) {//公用设备师
        _rightLab.text=@"个公用设备师";
    }
    else if ([self.menuId isEqualToString:@"142"]) {//电气工程师
        _rightLab.text=@"个电气工程师";
    }
    else if ([self.menuId isEqualToString:@"143"]) {//化工工程师
        _rightLab.text=@"个化工工程师";
    }
    else if ([self.menuId isEqualToString:@"144"]) {//监理工程师
        _rightLab.text=@"个监理工程师";
    }
    else if ([self.menuId isEqualToString:@"145"]) {//造价工程师
        _rightLab.text=@"个造价工程师";
    }
    else if ([self.menuId isEqualToString:@"146"]) {//消防工程师
        _rightLab.text=@"个消防工程师";
    }
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [DDSearchBuilderAndManagerListCell heightWithModel:model]+155-20;
    //return 155;
}
