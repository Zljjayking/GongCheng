...
@interface DDSearchBuyCompanyListVC ()<UITableViewDelegate,UITableViewDataSource,CitySelectTableViewDelegate,MoneySelectViewDelegate,DDCertiTypeSelectDelegate,UITextFieldDelegate>
...
//-(void)certiAndLevelSelect:(DDCertiTypeSelectVC *)certiSelectVC andCertiStr:(NSString *)certiStr andSection:(NSInteger)section andRows:(NSInteger)rows{
//
//}
//选择了资质类别和等级(带模型)
