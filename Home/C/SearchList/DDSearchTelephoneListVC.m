...
#import "DDAreaSelectTableView.h"//城市选择
#import "DDSearchTelephoneListModel.h"//model
#import "DDSearchHistoryDAOAndDB.h"//搜索历史数据库操作类

@interface DDSearchTelephoneListVC ()<UITableViewDelegate,UITableViewDataSource,AreaSelectTableViewDelegate,UITextFieldDelegate>
