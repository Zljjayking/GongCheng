//
//  DDLiveManagerMorePayEnsureVC.m
//  GongChengDD
//
...
#import "DDLiveManagerMorePayEnsureVC.h"
...
@interface DDLiveManagerMorePayEnsureVC ()<UITableViewDelegate,UITableViewDataSource,CNContactPickerDelegate,DDCitySelectPickerViewDelegate,DDPayMethodViewDelegate,UITextFieldDelegate,UITextViewDelegate>
...
@implementation DDLiveManagerMorePayEnsureVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        ...
        if (indexPath.row==0) {
            ...
            cell.titleLab2.text=@"现场施工管理人员继续教育";
        }
...
-(void)actionsheetDisappearAliPay:(DDPayMethodView *)actionSheet{
    ...
    [params setValue:@"现场施工管理人员继续教育" forKey:@"goodsName"];
    
    [params setValue:@"5" forKey:@"goodsType"];
...
-(void)createPaySuccessView{
    ...
    succeedVC.vcName=@"DDLiveManagerMoreAgencySelectVC_DDLiveManagerMoreAddApplyRecordVC";
...
//    bill.type=@"1";
//    bill.vcName=@"DDLiveManagerMoreAgencySelectVC_DDLiveManagerMoreAddApplyRecordVC";
...
//    myTrain.type=@"1";
//    myTrain.vcName=@"DDLiveManagerMoreAgencySelectVC_DDLiveManagerMoreAddApplyRecordVC";
