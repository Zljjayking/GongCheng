//
//  DDLiveManagerMoreAddApplyRecordVC.m
//  GongChengDD
//
...
#import "DDLiveManagerMoreAddApplyRecordVC.h"
#import "MJRefresh.h"
...
#import "DDLiveManagerMoreAddApplyVC.h"//添加人员页面
#import "DDLiveManagerMoreAddApplyRecordDetailVC.h"//添加报名记录详情页面

@interface DDLiveManagerMoreAddApplyRecordVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDLiveManagerMoreAddApplyRecordVC
...
-(void)newAddApplyClick{
    ...
    liveManagerMoreAddApply.agencyId=self.agencyId;
    liveManagerMoreAddApply.agencyName=self.agencyName;
    [self.navigationController pushViewController:liveManagerMoreAddApply animated:YES];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DDLiveManagerMoreAddApplyRecordDetailVC *liveManagerMoreAddApplyRecordDetail=[[DDLiveManagerMoreAddApplyRecordDetailVC alloc]init];
    [self.navigationController pushViewController:liveManagerMoreAddApplyRecordDetail animated:YES];
