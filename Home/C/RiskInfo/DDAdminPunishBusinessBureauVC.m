//
//  DDAdminPunishBusinessBureauVC.m
//  GongChengDD
//
...
#import "DDAdminPunishBusinessBureauVC.h"
...
@interface DDAdminPunishBusinessBureauVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDAdminPunishBusinessBureauVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyAdminPunishList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********行政处罚工商局结果数据***************%@",responseObject);
