//
//  DDAdminPunishConstructDeptVC.m
//  GongChengDD
//
...
#import "DDAdminPunishConstructDeptVC.h"
...
@interface DDAdminPunishConstructDeptVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDAdminPunishConstructDeptVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyAdminPunishList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********行政处罚建设部门结果数据***************%@",responseObject);
...
//                [_noResultView showWithTitle:@"暂无相关信息" subTitle:@"" image:@"noResult_content"];
