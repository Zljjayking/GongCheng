...
#import "DDOweTaxNoticeVC.h"
#import "DDLabelUtil.h"
#import "MJRefresh.h"
#import "DDNavigationUtil.h"
#import "DataLoadingView.h"//加载页面
#import "DDNoResult2View.h"//无数据视图
#import "DDOweTaxNoticeCell.h"//cell
#import "DDOweTaxNoticeModel.h"//model

@interface DDOweTaxNoticeVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDOweTaxNoticeVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_oweTaxNoticeList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********欠税公告结果数据***************%@",responseObject);
        ...
        if (response.isSuccess) {
            ...
            if (listArr.count!=0) {
                ...
                for (NSDictionary *dic in listArr) {
                    DDOweTaxNoticeModel *model = [[DDOweTaxNoticeModel alloc]initWithDictionary:dic error:nil];
                ...
                [_noResultView showWithTitle:@"暂无相关欠税公告的信息" subTitle:@"去其他地方看看~" image:@"noResult_info"];
            }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    DDOweTaxNoticeModel *model=_dataSourceArr[indexPath.section];
    
    static NSString * cellID = @"DDOweTaxNoticeCell";
    DDOweTaxNoticeCell * cell = (DDOweTaxNoticeCell *)[tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
