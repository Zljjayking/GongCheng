...
#import "DDCourtNoticeVC.h"
#import "MJRefresh.h"
#import "DDNavigationUtil.h"
#import "DataLoadingView.h"//加载页面
#import "DDNoResult2View.h"//无数据视图
#import "DDCompanyCourtNoticeCell.h"//cell
#import "DDCompanyCourtNoticeModel.h"//model
#import "DDCourtNoticeDetailVC.h"//法院公告详情页面

@interface DDCourtNoticeVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDCourtNoticeVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyCourtNoticeList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        ...
        if (response.isSuccess) {
            ...
            if (listArr.count!=0) {
                ...
                for (NSDictionary *dic in listArr) {
                    DDCompanyCourtNoticeModel *model = [[DDCompanyCourtNoticeModel alloc]initWithDictionary:dic error:nil];
                ...
                [_noResultView showWithTitle:@"暂无相关法院公告的信息" subTitle:@"去其他地方看看~" image:@"noResult_info"];
            }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    DDCompanyCourtNoticeModel *model=_dataSourceArr[indexPath.section];
    
    static NSString * cellID = @"DDCompanyCourtNoticeCell";
    DDCompanyCourtNoticeCell * cell = (DDCompanyCourtNoticeCell *)[tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
