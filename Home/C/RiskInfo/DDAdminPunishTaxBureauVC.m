...
#import "DDAdminPunishTaxBureauVC.h"
...
@interface DDAdminPunishTaxBureauVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDAdminPunishTaxBureauVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyAdminPunishList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********行政处罚税务局结果数据***************%@",responseObject);
