...
#import "DDAccidentSituationVC.h"
...
@interface DDAccidentSituationVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DDAccidentSituationVC
...
- (void)requestData{
    ...
    [[DDHttpManager sharedInstance]sendGetRequest:KHttpRequest_companyAccidentSituationList params:params success:^(NSURLSessionDataTask *operation, id responseObject) {
        NSLog(@"**********事故情况结果数据***************%@",responseObject);
        ...
        if (response.isSuccess) {
            ...
            if (listArr.count!=0) {
                ...
                [_noResultView showWithTitle:@"暂无相关事故情况的信息" subTitle:@"去其他地方看看~" image:@"noResult_info"];
            }
