//
//  DDAptitudeCertificateDetailWebVC.m
//  GongChengDD
//
//  Created by csq on 2017/12/6.
...
@interface DDAptitudeCertificateDetailWebVC ()<NBLScrollTabControllerDelegate>
@property (nonatomic, strong) NBLScrollTabController *scrollTabController;
@property (nonatomic, strong) NSMutableArray *viewControllers;
@end

@implementation DDAptitudeCertificateDetailWebVC
...
- (NSMutableArray *)viewControllers{
    if (!_viewControllers) {
        ...
        NSArray * titleArr = @[@"标准解读",@"标准原文",@"承揽范围"];
        NSArray *urlArr=@[@"1",@"2",@"3"];
